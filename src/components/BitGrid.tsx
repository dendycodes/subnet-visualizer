    ...
    <div className="flex flex-col items-center gap-4">
      <div className="flex flex-wrap justify-center gap-2.5 sm:gap-3.5">
        {octets.map((octetBits, oi) => (
          <div
            key={oi}
            className="flex gap-[3px] rounded-xl bg-ink/[0.055] dark:bg-ink/[0.03] p-1.5 sm:gap-1"
          >
      ...
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-ink/65 dark:text-ink/50">
